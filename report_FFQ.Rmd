...
> <br>
> <ul><li><b>FFQ model</b> assumes every individual has reported mean consumption per day for each food type 
...
```{r concen-plot, distPlot1_1FFQ, fig.show ='hold', out.width="600px", out.height="400px"}



distPlot1_1FFQ(input_lim, unit_concen, hazard_concen, input_upper, input_lower, n_sim, input_selectdist, input_selectscale, foodnamesused,
...
distPlot2_1FFQ(input_lim, food_consum, unit_consum, input_upper, input_lower, n_sim, input_selectdist, 
