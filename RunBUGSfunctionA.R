...
for(i in 1:nhM){
  ...
  if((input$priorchoice == "sigma_uniform")&(between.user.pvar == 1)){ 
    ...
    if((nhK>0)&(nhM>0)){
      ...
      parameters=c("mucK","mucM","sigcK","sigcM","mus0","Ts0","Ts","logitp0","Tp","muw","sigw","pM","pK")
    }
    if((nhK>0)&(nhM==0)){
      ...
      parameters=c("mucK","sigcK","mus0","Ts0","Ts","logitp0","Tp","muw","sigw","pK")
    }
    if((nhK==0)&(nhM>0)){
      ...
      parameters=c("mucM","sigcM","mus0","Ts0","Ts","logitp0","Tp","muw","sigw","pM")
    }  
  } # end of prior choice
